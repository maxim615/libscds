...
\
    ...
    void print_treeDecreasing_##TYPE (BinarySearchTree_##TYPE *this)\
    {\
        if(!treeNodeIsEmpty_##TYPE (this)){\
            print_treeDecreasing_##TYPE (this->rightChild);\
            print_##TYPE(this->content);\
            print_treeDecreasing_##TYPE (this->leftChild);\
        }\
    }\
    void print_treeIncreasing_##TYPE (BinarySearchTree_##TYPE *this)\
    {\
        if(!treeNodeIsEmpty_##TYPE (this)){\
            print_treeIncreasing_##TYPE (this->leftChild);\
            print_##TYPE(this->content);\
            print_treeIncreasing_##TYPE (this->rightChild);\
        }\
    }\
    void print_BinarySearchTree_##TYPE(BinarySearchTree_##TYPE *this){\
        print_treeIncreasing_##TYPE(this);\
    }\
